...
namespace mrHelper.StorageSupport
{
   ...
   ///<summary>
   internal class LocalGitRepositoryFactory : IDisposable
   {
      ...
      /// </summary>
      internal LocalGitRepositoryFactory(string parentFolder,
      ...
      /// Throws if
      /// </summary>
      internal ILocalGitCommitStorage GetRepository(ProjectKey key)
      {
         if (_isDisposed)
         {
            return null;
