...
namespace DarkModeForms
{
	...
	public class DarkModeCS
	{
		...
		public DarkModeCS(Form _Form, bool _ColorizeIcons = true, bool _RoundedPanels = false)
		{
			...
			if (originalWndProc == IntPtr.Zero)
			{
				_Form.HandleCreated += (sender, e) =>
				{
					...
					originalWndProc = SetWindowLong(_Form.Handle, GWLP_WNDPROC, Marshal.GetFunctionPointerForDelegate(newWndProcDelegate));
				};
			}
		...
		public void ThemeControl(Control control)
		{
			...
			if (!(control is mrHelper.App.Controls.HtmlPanelEx))
			{
			...
			{
				var panel = control as mrHelper.App.Controls.DiscussionPanel;
